$cnfFile = "D:\MillDol\BaseEAM_Cloud_SolutionItems\BaseEAM_BuildAutomation\my.cnf" #Config file
$backupDir = "D:\MillDol\BaseEAM_Cloud_SolutionItems\Database\Backup" #Backup Directory
